...
uint32_t BitMnistInference(int8_t *input) {
    ...
    uint8_t layer_in1[256];
    uint8_t layer_in2[256];

    processfclayer(input, L1_weights, L1_bitperweight, L1_incoming_weights, L1_outgoing_weights, layer_in1, 5);
    processfclayer(layer_in1, L2_weights, L2_bitperweight, L2_incoming_weights,  L2_outgoing_weights, layer_in2,3);
    processfclayer(layer_in2, L3_weights, L3_bitperweight, L3_incoming_weights,  L3_outgoing_weights, layer_in1,3);
    return processfclayer(layer_in1, L4_weights, L4_bitperweight, L4_incoming_weights,  L4_outgoing_weights, layer_in2,3);

/*
    ReLUNorm(layer_out, layer_in, L1_outgoing_weights,5);

    processfclayer(layer_in, L2_weights, L2_bitperweight, L2_incoming_weights,  L2_outgoing_weights, layer_out);
    ReLUNorm(layer_out, layer_in, L2_outgoing_weights,3);

    processfclayer(layer_in, L3_weights, L3_bitperweight, L3_incoming_weights,  L3_outgoing_weights, layer_out);
    ReLUNorm(layer_out, layer_in, L3_outgoing_weights,3);

    processfclayer(layer_in, L4_weights, L4_bitperweight, L4_incoming_weights,  L4_outgoing_weights, layer_out);
    return ReLUNorm(layer_out, layer_in, L4_outgoing_weights,3);*/
